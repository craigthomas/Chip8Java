...
public class Screen {
	 ...
	 */
	public Screen() throws FileNotFoundException, FontFormatException, IOException {
	 ...
	 * @throws IOException
	 */
	public Screen(int scale) throws FileNotFoundException, FontFormatException, IOException {
	 ...
	 * @throws FileNotFoundException 
	 */
	public Screen(int width, int height, int scale, String title) throws FileNotFoundException, FontFormatException, IOException {
		...
		overlayFont =  Font.createFont(Font.TRUETYPE_FONT, new FileInputStream(DEFAULT_FONT));
	 ...
	 * 
	 * @param cpu The CentralProcessingUnit object with the current state.
	 */
